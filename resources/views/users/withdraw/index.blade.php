            ...
            <div class="">
                <div class="rounded-xl border  p-4 bg-blue-600 h-100">
                    <div class="flex items-center justify-between">
                        <h5 class=" text-sm text-slate-50"> Balance<a tabindex="0" class="h6 mb-0" role="button"
                    ...
                    <h2 class="fw-bold text-white font-bold" style="font-size:2rem">${{ Auth::user()->balance }}
                    </h2>
