...
@section('content')
        ...
        <div class="flex">
            ...
            <div class="container mx-auto overflow-hidden">
                ...
                <div
                    ...
                    <div class=" w-full md:w-2/4 flex flex-col gap-3 text-center lg:text-left items-center md:items-start">
    ...
    <div class="py-10  flex items-center flex-col justify-center px-5">
        <h2 class="font-black text-center  text-2xl lg:text-5xl py-5 " id="plans">Recent Opportunities to invest in
        </h2>
    ...
    <div class="container mx-auto px-5">
        <div class="flex flex-col md:flex-row  py-10 gap-8 justify-around">
            <div class="lg:w-1/3 ">
                ...
                <img src="{{ asset('assets\images\faq.png') }}" class="hidden md:block mt-5 max-h-80" alt="Faq icon">
    ...
    <div class="border-t  container mx-auto"></div>
    {{-- testmimonial --}}
    <div class="flex flex-col justify-center  w-full mx-auto p overflow-hidden pb-6 relative lg:pt-16">
        <div class="flex items-center font-black gap-4 mx-auto">
            <div class="w-max rounded-full bg-[#111]">
                <x-authentication-card-logo :width="'50'" />
            </div>
            {{ config('app.name') }}
        </div>
        <h3 class="font-bold text-2xl lg:text-4xl mx-auto">What Our Happy Clients Are Saying</h3>
        {{-- comments  --}}
