    ...
    <div class="pt-4 bg-gray-100">
        <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
            ...
            <div class="w-full sm:max-w-3xl mt-6 p-6 overflow-hidden sm:rounded-lg prose">
                ...
                <h1 class="mb-5 mt-5 text-decoration-underline">Privacy Policy</h1>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to NovaCoin Holding’s, 545 Mavis
                    ...
                    <li>
                        <p><strong>Website</strong> refers to NovaCoin Holding’s, accessible from <a
                                href="https://NovaCoin Holding’s.com"
                                rel="external nofollow noopener"
                                target="_blank"
                            >https://NovaCoin Holding’s.com</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        <p>By visiting this page on our website: <a
                                href="https://NovaCoin Holding’s.com/contactus.php"
                                rel="external nofollow noopener"
                                target="_blank"
                            >https://NovaCoin Holding.com/contactus.php</a></p>
                    </li>
                </ul>
            </div>
        </div>
