        ...
        <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
            <div class="bg-white border rounded-lg py-5">
                ...
                <div class="w-full sm:max-w-3xl mt-3 p-6 overflow-hidden sm:rounded-lg prose">
                    ...
                    <h1 class="mb-5 mt-0 text-decoration-underline">Privacy Policy</h1>
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                                &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to NovaCoin Holding’s, 545
                                Mavis
                                Island Chicago, IL 99191.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to NovaCoin Holding’s, accessible from By visiting this page on our website: <a
    href="{{ config('app.url') }}/contactus.php" rel="external nofollow noopener"
    target="_blank">{{ config('app.url') }}/contactus.php</a></>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            <p>By email: contact@NovaCoin Holding’s.com</p>
                        </li>
                        <li>
                            <p>By visiting this page on our website: <a
                                href="{{ config('app.url') }}/contactus.php" rel="external nofollow noopener"
                                target="_blank">{{ config('app.url') }}/contactus.php</a></p>
                        </li>
                    </ul>
                </div>
            </div>
