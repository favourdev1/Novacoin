<x-terms-layout>
    <div class="pt-4 bg-gray-100">
        <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
            ...
            <div class="w-full sm:max-w-3xl mt-6 p-6 overflow-hidden sm:rounded-lg prose">
                    <h2 class="mb-4 text-decorator-underline mt-5"><strong>Terms and Conditions</strong></h2>

            <p>Welcome to NovaCoin Holding’s!</p>

            <p>These terms and conditions outline the rules and regulations for the use of NovaCoin Holding’s Website,
                located at https://decastlesampatti.com.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                NovaCoin Holding’s if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <p>We employ the use of cookies. By accessing NovaCoin Holding’s, you agreed to use cookies in agreement with
                the NovaCoin Holding’s Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, NovaCoin Holding’s and/or its licensors own the intellectual property rights for
                all material on NovaCoin Holding’s. All intellectual property rights are reserved. You may access this
                from NovaCoin Holding’s for your own personal use subjected to restrictions set in these terms and
                conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from NovaCoin Holding’s</li>
                <li>Sell, rent or sub-license material from NovaCoin Holding’s</li>
                <li>Reproduce, duplicate or copy material from NovaCoin Holding’s</li>
                <li>Redistribute content from NovaCoin Holding’s</li>
            </ul>
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. NovaCoin Holding’s does not filter, edit, publish or review Comments prior
                to their presence on the website. Comments do not reflect the views and opinions of NovaCoin Holding’s,its
                agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                opinions. To the extent permitted by applicable laws, NovaCoin Holding’s shall not be liable for the
            ...
            <p>DecastleSampatti reserves the right to monitor all Comments and to remove any Comments which can be
            ...
            <p>You hereby grant NovaCoin Holding’s a non-exclusive license to use, reproduce, edit and authorize others to
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of NovaCoin Holding’s; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to NovaCoin Holding’s. Please include your name, your
            ...
            <p>No use of NovaCoin Holding’s logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
